...
product_is_veg = driver.find_elements(by=By.XPATH, value="//*[@id='dynamicDirective']/product-deck/section/div[2]/div[4]/div[1]/div/div/div[2]/div/div/product-template/div/div[3]/span")
...
for i in range(len(product_name)):
    element_list.append([product_name[i].text, product_mrp[i].text, product_d_mrp[i].text, product_delivery[i].text, percent[i].text, product_is_veg[i].text]) 
